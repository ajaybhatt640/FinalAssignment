var markers ={
   ...
   function LoadMap() {
    var mapOptions = {
    center: new google.maps.LatLng(markers.doctorListing[0].address.lat, markers.doctorListing[0].address.lng),
    zoom: 8,
    ...
    for (var i = 0; i < markers.doctorListing.length; i++) {
    var data = markers.doctorListing[i].address
    ...
    infoWindow.setContent("<div style = 'width:200px;min-height:100px'>" + data.addressLineTwo + "</div>");
